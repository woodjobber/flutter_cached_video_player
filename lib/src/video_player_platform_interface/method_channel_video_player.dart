...
/// this repository.
class MyCustomMethodChannelVideoPlayer extends VideoPlayerPlatform {
  /// Create static [MyCustomMethodChannelVideoPlayer] instance.
  ///
  static VideoPlayerPlatform share = MyCustomMethodChannelVideoPlayer();

  final VideoPlayerApi _api = VideoPlayerApi();

  static VideoPlayerPlatform get instance => share;
